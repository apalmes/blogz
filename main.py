...
def signup():
    ...
    if request.method == 'POST':
        ...
        # TODO: this error handling can be replaced with flash messages
        username_error = ''
        password_error = ''
        verify_error = ''
        ...
        if not username_error and not password_error and not verify_error and not existing_user:
            ...
            return render_template('signup.html', title='Sign-up', username_error=username_error,
                                   password_error=password_error, verify_error=verify_error, page_title=page_title)
...
def blogs():
    users = User.query.all()
    # TODO: you can query the blog entries by date descending
